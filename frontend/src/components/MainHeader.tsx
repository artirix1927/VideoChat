...
export const MainHeader = () => {
    return <>
        <div className="header-section m-12 font-mono">
      
            <div className="py-50 px-100 flex justify-center flex-col gap-6 text-center">
            <h1 className="text-4xl">Unlock Boundless Connections with Video Calls</h1>
